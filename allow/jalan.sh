...
dx=$(ls /etc/.maAsiss/public_mode --ignore='settings' | wc -l)
   ...
   env_msg+="•VMess/VLess WS TLS : $tls/$none\n"
   env_msg+="•VMess/VLess WS Non TLS : $tls1/$none1\n"
   env_msg+="━━━━━━━━━━━━━━━━━━━━━\n"
...
ShellBot.InlineKeyboardButton --button 'pub_menu' --line 3 --text '• VMESS •' --callback_data 'vmess'
